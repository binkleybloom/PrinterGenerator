...
parser.add_argument('--driverpkg', help='Name of required driver installation pkg in munki repository.')
...
if args.csv:
    ...
    with open(args.csv, mode='r') as infile:
        ...
        for row in reader:
            ...
            newPlist['requires'][0] = row[6]
            newPlist['name'] = "printer-" + str(row[0]) # set to printer name
            ...
            # Write out the file
            newFileName = "printer-" + row[0] + "-1.0.plist"
